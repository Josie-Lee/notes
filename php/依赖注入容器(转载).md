# PHP程序员如何理解依赖注入容器(dependency injection container)(转载)

转载自  [segmentfault@auth:zhaoyi](https://segmentfault.com/a/1190000002424023)
## 背景知识
...
其他相关：http://www.jianshu.com/p/cb0693dd8d2e